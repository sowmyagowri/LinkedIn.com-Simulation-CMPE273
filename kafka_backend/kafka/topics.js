...
const POST_APPLICANT_PROFILE_SKILLS_REQUEST =  "postApplicantProfileSkillsRequest";
const POST_APPLICANT_PROFILE_SKILLS_RESPONSE = "postApplicantProfileSkillsResponse";
...
module.exports = {
    ...
    SIGNUP_APPLICANT_CHECK_REQUEST_TOPIC, SIGNUP_APPLICANT_CHECK_RESPONSE_TOPIC,
    ...
    POST_APPLICANT_PROFILE_SKILLS_REQUEST, POST_APPLICANT_PROFILE_SKILLS_RESPONSE,
    POST_APPLICANT_PROFILE_PHOTO_REQUEST, POST_APPLICANT_PROFILE_PHOTO_RESPONSE,
    GRAPH_SAVED_JOBS_REQUEST,GRAPH_SAVED_JOBS_RESPONSE,
    ...
    SEND_CONNECTION_REQUEST, SEND_CONNECTION_RESPONSE,
    GET_ALL_CONNECTION_REQUEST, GET_ALL_CONNECTION_RESPONSE,
    CONNECTION_RESPONSE_REQUEST, CONNECTION_RESPONSE_RESPONSE,
    FETCH_JOBS_REQUEST,FETCH_JOBS_RESPONSE,
    APPLY_FOR_JOB_REQUEST, APPLY_FOR_JOB_RESPONSE,
    SAVE_JOB_REQUEST, SAVE_JOB_RESPONSE,
    GET_ALL_SAVED_JOBS_REQUEST, GET_ALL_SAVED_JOBS_RESPONSE,
    DELETE_PROFILE_REQUEST, DELETE_PROFILE_RESPONSE,
    SEARCH_JOBS_REQUEST, SEARCH_JOBS_RESPONSE,
    SEARCH_PEOPLE_REQUEST, SEARCH_PEOPLE_RESPONSE,
    GRAPH_PROFILE_VIEWS_REQUEST, GRAPH_PROFILE_VIEWS_RESPONSE,
    UPDATE_PROFILE_VIEWS_REQUEST, UPDATE_PROFILE_VIEWS_RESPONSE,
    GET_ALL_APPLICATIONS_REQUEST, GET_ALL_APPLICATIONS_RESPONSE
};