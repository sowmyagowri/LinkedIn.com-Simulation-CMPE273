...
var postApplicantProfileResumeService = require('./services/postApplicantProfileResume');
...
const {
    ...
    POST_APPLICANT_PROFILE_PHOTO_REQUEST, POST_APPLICANT_PROFILE_RESUME_REQUEST,
...
handleTopicRequest(POST_APPLICANT_PROFILE_RESUME_REQUEST, postApplicantProfileResumeService);
