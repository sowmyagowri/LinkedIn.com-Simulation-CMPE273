...
const { GET_ALL_MESSAGES_REQUEST, GET_ALL_MESSAGES_RESPONSE } = require('./../kafka/topics');
...
router.get("/", (req, res) => {
    ...
    if (errors) {
        ...
        kafka.make_request(GET_ALL_MESSAGES_REQUEST, GET_ALL_MESSAGES_RESPONSE, req.body, function (err, result) {
            if (err) {
