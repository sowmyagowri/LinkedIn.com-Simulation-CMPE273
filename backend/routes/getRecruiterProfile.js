...
const { GET_RECRUITER_PROFILE_REQUEST, GET_RECRUITER_PROFILE_RESPONSE } = require('./../kafka/topics');
 ...
 */
router.get("/", (req, res) => {
    console.log("Inside get Recruiter Profile controller");
    console.log("GETRECRUITERPROFILE: ", req.query);
    ...
    if (errors) {
        ...
        kafka.make_request(GET_RECRUITER_PROFILE_REQUEST, GET_RECRUITER_PROFILE_RESPONSE, req.query, function (err, result) {
            if (err) {
