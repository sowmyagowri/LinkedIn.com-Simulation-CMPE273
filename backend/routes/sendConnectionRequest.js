...
const { SEND_CONNECTION_REQUEST, SEND_CONNECTION_RESPONSE, } = require('./../kafka/topics');
...
router.post("/", (req, res) => {
    ...
    if (errors) {
        ...
        kafka.make_request(SEND_CONNECTION_REQUEST, SEND_CONNECTION_RESPONSE, req.body, function (err, result) {
            if (err) {
