...
const { SEND_MESSAGE_REQUEST, SEND_MESSAGE_RESPONSE, } = require('./../kafka/topics');
...
router.post("/", (req, res) => {
    ...
    if (errors) {
        ...
        kafka.make_request(SEND_MESSAGE_REQUEST, SEND_MESSAGE_RESPONSE, req.body, function (err, result) {
            if (err) {
