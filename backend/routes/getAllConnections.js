...
const { GET_ALL_CONNECTION_REQUEST, GET_ALL_CONNECTION_RESPONSE } = require('./../kafka/topics');
...
router.get("/", (req, res) => {
    ...
    if (errors) {
        ...
        kafka.make_request(GET_ALL_CONNECTION_REQUEST, GET_ALL_CONNECTION_RESPONSE, req.body, function (err, result) {
            if (err) {
