...
const { GRAPHS_CLICK_PER_JOB_REQUEST, GRAPHS_CLICK_PER_JOB_RESPONSE } = require('./../kafka/topics');
...
router.get("/", (req, res) => {
    ...
    if (errors) {
        ...
        kafka.make_request(GRAPHS_CLICK_PER_JOB_REQUEST, GRAPHS_CLICK_PER_JOB_RESPONSE, req.query, function (err, result) {
            if (err) {
