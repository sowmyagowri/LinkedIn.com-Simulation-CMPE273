...
const { GET_JOBS_BY_RECRUITER_REQUEST, GET_JOBS_BY_RECRUITER_RESPONSE } = require('./../kafka/topics');
...
router.get("/", (req, res) => {
    ...
    if (errors) {
        ...
        kafka.make_request(GET_JOBS_BY_RECRUITER_REQUEST, GET_JOBS_BY_RECRUITER_RESPONSE, req.query, function (err, result) {
            if (err) {
