...
const { GRAPHS_LOG_EVENT_REQUEST, GRAPHS_LOG_EVENT_RESPONSE } = require('./../kafka/topics');
 ...
 */
router.get("/", (req, res) => {
    console.log("Inside get Graph for Log Events controller");
    console.log("GETGRAPHPFORLOGEVENTS: ", req.query);
    ...
    if (errors) {
        ...
        kafka.make_request(GRAPHS_LOG_EVENT_REQUEST, GRAPHS_LOG_EVENT_RESPONSE, req.query, function (err, result) {
            if (err) {
