...
const { UPDATE_JOB_CLICKS_REQUEST, UPDATE_JOB_CLICKS_RESPONSE } = require('./../kafka/topics');
 ...
 */
router.post("/", (req, res) => {
    console.log("Inside Update Job Clicks controller");
    console.log("UPDATEJOBCLICKS: ", req.body);
    ...
    if (errors) {
        ...
        kafka.make_request(UPDATE_JOB_CLICKS_REQUEST, UPDATE_JOB_CLICKS_RESPONSE, req.body, function (err, result) {
            if (err) {
