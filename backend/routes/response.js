/**
 * creates and sends the success response, with success: true, and message: Successful, 
 * you can customize the message by sending it in data (second argument)
 * 
 * @param {object} resp - express response object 
 * @param {object} data - data to be sent in response, default value is empty object.
 */
 ...
 * 
 * @param {object} resp - express response object 
 * @param {object} data - default {}, pass this argument for logging purpose only, this won't be sent to caller
 */
 ...
 * 
 * @param {object} resp - express response object 
 * @param {object} data - default {}, data to be sent to caller.
 */
 ...
 * this method will respond with internal server error.
 * 
 * @param {object} resp - express response object 
 * @param {object} result - data to be sent to caller, result object must have code defined in it.
 */
const responseHandler = (resp, result = {}) => {
    //if needed handle other result codes, 
    //make sure to put a break statement after handling the response.
...
module.exports = { 
    sendSuccess, sendAuthenticationFailure, sendAuthorizationFailure,
    sendInternalServerError, sendBadRequest, responseHandler 
};