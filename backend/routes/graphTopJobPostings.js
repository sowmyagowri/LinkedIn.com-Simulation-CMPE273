...
const { GRAPHS_TOP_JOB_POSTINGS_REQUEST, GRAPHS_TOP_JOB_POSTINGS_RESPONSE } = require('./../kafka/topics');
...
router.get("/", (req, res) => {
    ...
    if (errors) {
        ...
        kafka.make_request(GRAPHS_TOP_JOB_POSTINGS_REQUEST, GRAPHS_TOP_JOB_POSTINGS_RESPONSE, req.query, function (err, result) {
            if (err) {
