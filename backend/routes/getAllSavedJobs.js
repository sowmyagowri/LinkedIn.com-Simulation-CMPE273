...
const { GET_ALL_SAVED_JOBS_REQUEST, GET_ALL_SAVED_JOBS_RESPONSE } = require('./../kafka/topics');
...
router.get("/", (req, res) => {
    ...
    if (errors) {
        ...
        kafka.make_request(GET_ALL_SAVED_JOBS_REQUEST, GET_ALL_SAVED_JOBS_RESPONSE, req.query, function (err, result) {
            if (err) {
