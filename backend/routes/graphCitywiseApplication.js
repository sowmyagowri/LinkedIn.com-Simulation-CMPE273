...
const { GRAPHS_CITYWISE_APPLICATION_REQUEST, GRAPHS_CITYWISE_APPLICATION_RESPONSE } = require('./../kafka/topics');
...
router.get("/", (req, res) => {
    ...
    if (errors) {
        ...
        kafka.make_request(GRAPHS_CITYWISE_APPLICATION_REQUEST, GRAPHS_CITYWISE_APPLICATION_RESPONSE, req.query, function (err, result) {
            if (err) {
