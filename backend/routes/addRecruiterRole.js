...
const { ADD_RECRUITER_ROLE_REQUEST, ADD_RECRUITER_ROLE_RESPONSE } = require('./../kafka/topics');
...
router.post("/", (req, res) => {
    ...
    if (errors) {
        ...
        kafka.make_request(ADD_RECRUITER_ROLE_REQUEST, ADD_RECRUITER_ROLE_RESPONSE, req.body, function (err, result) {
            if (err) {
