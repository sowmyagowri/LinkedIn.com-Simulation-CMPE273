                        ...
                        <div className = "invitation-card__info-wrapper">
                            <div className = "invitation-card__details">
                                ...
                                <div className = "msg-conversation-card__row pr2">
                                    ...
                                    <div className = "row" style = {{marginLeft : "15px"}}>
                                        <div className = "form-group">
                                            <h5 className = "t-14 t-black t-normal">{invitations[i].firstName}&nbsp;{invitations[i].lastName}</h5>
                                ...
                                <div className = "invitation-card__action-container pl3 pr5">
                                        <button type="submit" className="btn arteco-btn-save" onClick = {(event) => self.connectionresponse(event, "n", invitations[i], i)}>Ignore</button>
                                        <button type="submit" className="btn arteco-btn" onClick = {(event) => self.connectionresponse(event, "y", invitations[i], i)} style={{ marginLeft: "10px" }}>Accept</button>
                                </div>  
                                </div>
                            </div>
                        </div>
