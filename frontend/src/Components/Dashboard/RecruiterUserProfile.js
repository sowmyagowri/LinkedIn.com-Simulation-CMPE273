                        ...
                        <div className="Elevation-2dp profile-background-image profile-background-image--loading ember-view">
                            ...
                            <div className="pv-profile-section pv-top-card-section artdeco-container-card ember-view">
                                ...
                                <div className="col-md-12" style = {{width : "800px"}}>
                                    ...
                                    {this.state.profiledata.phoneNumber ? <p><strong>Phone Number: </strong> {this.state.profiledata.phoneNumber} </p>  : (null)}
                                    </div>
                                    </div>
                                    <hr/>
                                ...
                                {!this.state.requestconnection ? 
                                        <button type="button" className="btn arteco-btn" style = {{width : "150px", marginLeft : "20px"}} onClick = {this.sendRequest}>Send Request</button> 
                                : (null)}
                                <SendMessage postMessage ={this.props.postMessage} connection = {this.state.profiledata}></SendMessage>
                                </div>
                            </div>
                        </div>
            </div>
...
form: "Search_People"
})(connect(mapStateToProps, {postMessage, makeconnections})(RecruiterUserProfile)));