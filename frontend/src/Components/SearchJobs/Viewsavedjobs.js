...
class Easyapply extends Component{
    ...
    render() {
        ...
        return (
            <div>
                <button type="button" className="btn arteco-btn" data-toggle="modal" data-target={"#easyapplymodal"+id} style={{ marginLeft: "10px", width : "150px" }}>Easy Apply</button>
              <div className="modal fade  bd-example-modal-lg" id={'easyapplymodal'+id} tabIndex="-1" role="dialog" aria-labelledby={'easyapplymodallabel'+id} aria-hidden="true"style = {{marginTop : "70px"}}>
                   <div className="modal-dialog modal-dialog-centered modal-lg" style = {{maxWidth: "1000px"}}>
                       <div className="modal-content">
                           <div className="modal-header">
                               <h5 className="modal-title" id={'easyapplymodallabel'+id}>Easy Apply</h5>
                           ...
                           <div className="modal-body">
                            ...
                            <figure>
                                <img alt="" src = "/images/avatar.png" style = {{width : "40px", height : "40px"}}/>&nbsp;&nbsp;{profile.firstName}&nbsp;{profile.lastName} 
                            </figure>
                            </div>
                        ...
                        <div className="modal-footer" style = {{height : "60px", border : "none"}}>
                        {!this.handleValidation() ?
                        <button className = "btn arteco-btn" type = "submit"  style = {{marginBottom : "100px"}} >Submit</button> :
                        <button className = "btn arteco-btn" type = "submit"  data-dismiss="modal"  style = {{marginBottom : "100px"}} onClick = {this.submitApply}>Submit</button>}
                        </div>
                        </div>
                    </div>    
                </div>
...
export default withRouter(reduxForm({
    form: "View_Savedjobs"
    })(connect(mapStateToProps, { getsavedjobs, applyjob, getapplicantprofile}) (ViewSavedJobs)));