                ...
                <div className = "artdeco-scrolling-container">
                    <div className = "artdeco-tabpanel">
                                ...
                                <div className="row form-group">
                                    ...
                                    <div className="row form-group">
                                        <div className = "col-xs-6 col-md-6">
                                            ...
                                            <input className = "form-control" name = "ethnicity" id="ethnicity-question"  onBlur={this.halffilled('ethnicity')} onChange = {this.changeHandler} type="text" placeholder=""/>
                                        </div>
                                        <div className = "col-xs-6 col-md-6">
                                            <label htmlFor = "question-question" className = "question-apply">How did you hear about us?</label>
                                            <input className = "form-control" name = "question" id="question-question" onBlur={this.halffilled('question')} onChange = {this.changeHandler} type="text" placeholder=""/>
                                        </div>
                                    </div>
                            </li>
                        </section>
                        <section className = "section-profile ember-view">
                            ...
                            <div className="radio">
                                <h4><label>
                                    <input type="radio" value = "True" name="sponsorship" onBlur={this.halffilled('sponsorship')} onChange={this.changeHandler} />&nbsp;&nbsp;Yes</label> </h4>
                                <h4><label>
                                    <input type="radio" value = "False" checked={this.state.sponsorship === "False"} onBlur={this.halffilled('sponsorship')} name="sponsorship" onChange={this.changeHandler} />&nbsp;&nbsp;No</label> </h4>
                                <br />
                            </div>
                            ...
                            <div className="radio">
                                <h4><label>
                                    <input type="radio" value = "True" name="disability"  onBlur={this.halffilled('disability')}  onChange={this.changeHandler} />&nbsp;&nbsp;Yes</label> </h4>
                                <h4><label>
                                    <input type="radio" value = "False" checked={this.state.disability === "False"} onBlur={this.halffilled('disability')}  name="disability" onChange={this.changeHandler} />&nbsp;&nbsp;No</label> </h4>
                                <br />
                            </div>
                        ...
                        <div className = "profile-title" style = {{fontSize : "19px"}}>Resume</div>
                            <div className="form-group">
                                <input type="file" id="resume" onChange={this.uploadresume} onBlur={this.halffilled('resume')} style = {{display : "none"}}/>
                            ...
                            <div className="form-group">
                                <input type="file" id="coverletter" onBlur={this.halffilled('coverletter')} onChange={this.uploadcoverletter} style = {{display : "none"}}/>
                                <button type="file" className="btn arteco-btn-save" id="position-coverletter-typeahead" onClick = {this.openCoverletterDialog} style = {{width : "180px"}}>Upload Coverletter
