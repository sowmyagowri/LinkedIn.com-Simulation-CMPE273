...
function addJobs() {
    var recruiter_email = [
        'recruiteremail151@gmail.com', 'recruiteremail152@gmail.com', 'recruiteremail153@gmail.com', 'recruiteremail154@gmail.com', 'recruiteremail155@gmail.com',
        'recruiteremail156@gmail.com', 'recruiteremail157@gmail.com', 'recruiteremail158@gmail.com', 'recruiteremail159@gmail.com', 'recruiteremail160@gmail.com'
    ]
    ...
    var title = [
        'Software Engineer', 'System Engineer', 'Architect', 'Human Resources Manager', 'Manager',
        'Civil Engineer', 'Electrical Engineer'
    ]

    var company_list = [
        'Google', 'Facebook', 'Microsoft', 'Intel', 'Cisco', 'Adobe'
    ]

    var company_logo_dic = {
        'Google' : 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Google_"G"_Logo.svg/145px-Google_"G"_Logo.svg.png',
        'Facebook' : 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Facebook_logo_%28square%29.png/600px-Facebook_logo_%28square%29.png',
        'Microsoft' : 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Microsoft_logo.svg/878px-Microsoft_logo.svg.png',
        'Intel' : 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Intel-logo.svg/200px-Intel-logo.svg.png',
        'Cisco' : 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Cisco_logo.svg/200px-Cisco_logo.svg.png',
    ...
    var industry_list = [
        'Technology', 'Civil', 'Government', 'Manufacturing', 'Cottage' 
    ]
    ...
    for (var i = 5; i < 101; i++) {
        ...
        var company_temp = company_list[Math.floor(Math.random()*company_list.length)];
        var data = {
            ...
            jobFunction : 'tempor orci dapibus ultrices in iaculis nunc sed augue lacus viverra vitae congue eu consequat ac felis donec et odio',
