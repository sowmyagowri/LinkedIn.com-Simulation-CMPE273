...
var address_list = [
    '312 Gough', '112 Van Ness', '2032 California', '12 Market Street'
]
...
var state_list = [
    'California', 'New York', 'Washington', 'Florida', 'Illinois'
]

var zipcode_list = [
    '94104', '67210', '12690', '65390'
]

var phoneNumber_list = [
    '1123345678', '3432321212', '6689907765', '6674432123'
]
...
function addRecruiters() {
    ...
    for (var i = 156; i < 161; i++) {
        var profiledata = {
            ...
            phoneNumber: phoneNumber_list[Math.floor(Math.random() * phoneNumber_list.length)],
            companyName: companyName_list[Math.floor(Math.random() * companyName_list.length)],
        }
