...
var state_lsit = [
    'Illinois', 'California', 'New York', 'Michigan', 'Florida'
]

var city_list = [
    'Chicago', 'San Jose', 'San Francisco', 'New York', 'Seattle', 'Detroit', 'Orlando'
]

var zipcode_list = [
    '65210', '97104', '99210', '54321', '54320'
]

var title_list = [
    'Manager', 'Software Engineer', 'Industrial Engineer', 'Data Analyst', 'System Engineer'
]

var company_list = [
    'Twitter', 'Amazon', 'Google', 'Uber', 'IBM'
] 

var location_list = [
    'Seattle, United States', 'Chicago, United States', 'San Jose, United States', 'New York, United States'
]

var fromMonth_list = [
    'July', 'August', 'January', 'May', 'June', 'December'
]
...
var school_list = [
    'San Jose State University', 'Boston University', 'California State University'
]
...
function addUsers() {
    for (var i = 6; i < 11; i++) {
        ...
        var data = {
            ...
            fromMonth: fromMonth_list[Math.floor(Math.random() * fromMonth_list.length)],
